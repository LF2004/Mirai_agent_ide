...
contextBridge.exposeInMainWorld('mirai', {
  ...
  agentPickAttachments: () => ipcRenderer.invoke('agent:pick-attachments'),
  agentReadAttachment: (filePath) => ipcRenderer.invoke('agent:read-attachment', filePath),
  ...
  agentRenameSession: (payload) => ipcRenderer.invoke('agent:rename-session', payload),
